...
const I18N = {
  en: {
    ...
    "hero.subtitle": "A modern full-service salon dedicated to enhancing natural beauty through personalized care. We specialize in hair, skin and beauty services in a space where every client feels comfortable, confident and cared for.",
    ...
    "about.title": "Enhancing natural beauty through personalized care",
    "about.body": "The Beauty Loft is a modern full-service salon dedicated to enhancing natural beauty through personalized care. We specialize in hair, skin and beauty services, creating a space where every client feels comfortable, confident and cared for.",
    "about.body2": "From brows and lashes to color, cuts, treatments and body services — every appointment is built around you and finished with the attention to detail that has made The Beauty Loft a Kips Bay favorite.",
  ...
  es: {
    ...
    "hero.subtitle": "Un salón moderno de servicio completo dedicado a realzar la belleza natural a través de cuidado personalizado. Nos especializamos en cabello, piel y belleza en un espacio donde cada clienta se siente cómoda, segura y cuidada.",
    ...
    "about.title": "Realzando la belleza natural con cuidado personalizado",
    "about.body": "The Beauty Loft es un salón moderno de servicio completo dedicado a realzar la belleza natural a través de cuidado personalizado. Nos especializamos en cabello, piel y belleza, creando un espacio donde cada clienta se siente cómoda, segura y cuidada.",
    "about.body2": "Desde cejas y pestañas hasta color, cortes, tratamientos y servicios corporales — cada cita se construye en torno a ti y se cierra con la atención al detalle que hace de The Beauty Loft un favorito en Kips Bay.",
